...
ActiveRecord::Schema.define(version: 20_200_318_065_908) do
  ...
  create_table 'parking_slots', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index ['vehical_id'], name: 'index_parking_slots_on_vehical_id'
  end
  ...
  create_table 'payment_records', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index ['member_id'], name: 'index_payment_records_on_member_id'
  end
  ...
  create_table 'vehicals', force: :cascade do |t|
    ...
    t.datetime 'updated_at', precision: 6, null: false
    t.text 'description'
    t.index ['member_id'], name: 'index_vehicals_on_member_id'
  end
